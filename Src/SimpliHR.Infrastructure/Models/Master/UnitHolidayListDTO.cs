...
public partial class UnitHolidayListDTO
{
...
public partial class UnitHolidayListVM
{
    public int? HttpStatusCode { get; set; } = 200;

    public List<UnitMasterDTO>? Units { get; set; } = new List<UnitMasterDTO>();
    public List<PageKeyValues>? HolidayTypes { get; set; } = new List<PageKeyValues>();
    public UnitHolidayListDTO? UnitHolidays { get; set; }=new UnitHolidayListDTO();
    public List<UnitHolidayListDTO>? UnitHolidayList { get; set; } = new List<UnitHolidayListDTO>();
    public List<HolidaysListMasterDTO>? HolidayMasterList { get; set; } = new List<HolidaysListMasterDTO>();
