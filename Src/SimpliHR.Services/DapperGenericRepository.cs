...
public class DapperGenericRepository<T> : IDapperRepository<T> where T : class, new()
{
    ...
    public DapperGenericRepository(DapperDBContext dapperDBContext)
    {
        ...
        //    //_dbSettings.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SimplyDBConnection"].ToString();
        //    _dbSettings.ConnectionString = "Data Source=tcp:mysimplyhr.database.windows.net,1433;Initial Catalog=simplihr2uat-db;User ID=SimpliHR;Password=Delta@304020;Encrypt=False;";
        //DbConnection = new DapperDBContext().SetStrategy()
        //    .GetDbContext(_dbSettings.ConnectionString);
        //  _connection = new SqlConnection("Data Source=WIN-36HUGSR0RR8;Initial Catalog=SimpliHRdb;User ID=sa;Password=WEMhg13@fdT;Encrypt=False;");
        // _connection = new SqlConnection("Data Source=ASIF\\SQLEXPRESS;Initial Catalog=Simpli2HRDb;Integrated Security=true;Encrypt=False;");
        // _connection = new SqlConnection("Data Source=WIN-36HUGSR0RR8;Initial Catalog=SimpliHRdb;User ID=sa;Password=WEMhg13@fdT;Encrypt=False;");
        _connection = new SqlConnection("Data Source=182.18.138.110;Initial Catalog=EHRMS_Testing;User ID=sa;Password=CG$sBK9%!8P4c$;Encrypt=False;");
