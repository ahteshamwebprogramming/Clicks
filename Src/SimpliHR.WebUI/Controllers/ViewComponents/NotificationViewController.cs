...
namespace SimpliHR.WebUI.Controllers.ViewComponents
{
    ...
    public class NotificationViewController : ViewComponent
    {
        private readonly ClientController _clientSettingAPIController;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public NotificationViewController(ClientController clientSettingAPIController, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            if (int.TryParse(HttpContext.Session.GetString("ClientId"), out output) == true)
            {
                ...
                sideBar.Menus = menus;
                return View("Notification", sideBar);
            }
            else
            {
